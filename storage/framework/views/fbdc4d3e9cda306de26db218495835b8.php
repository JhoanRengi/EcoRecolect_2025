...
<link rel="stylesheet" href="<?php echo e(asset('css/landing_page.css')); ?>">
    ...
    <div class="container p-5" style="z-index: 10;">
        <div class="row">
            ...
            <div class="col-12 col-lg-8">
                ...
                <button
                    onclick="window.location='<?php echo e(route('register')); ?>'"
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-12 col-md-6 col-lg-3 d-flex mb-4">
            <div class="card shadow-sm border-0 rounded-3 overflow-hidden w-100">
                ...
                <img src="<?php echo e(asset('images/recoleccion_especializada.png')); ?>" class="card-img-top" alt="Recolección Especializada">
        ...
        <div class="col-12 col-md-6 col-lg-3 d-flex mb-4">
            <div class="card shadow-sm border-0 rounded-3 overflow-hidden w-100">
                <img src="<?php echo e(asset('images/impacto_real.png')); ?>" class="card-img-top" alt="Impacto Real">
                <div class="card-body p-3 bg-white">
        ...
        <div class="col-12 col-md-6 col-lg-3 d-flex mb-4">
            <div class="card shadow-sm border-0 rounded-3 overflow-hidden w-100">
                <img src="<?php echo e(asset('images/a_la_mano.png')); ?>" class="card-img-top" alt="A la Mano">
                <div class="card-body p-3 bg-white">
        ...
        <div class="col-12 col-md-6 col-lg-3 d-flex mb-4">
            <div class="card shadow-sm border-0 rounded-3 overflow-hidden w-100">
                <img src="<?php echo e(asset('images/recompensa.png')); ?>" class="card-img-top" alt="Recompensa">
                <div class="card-body p-3 bg-white">
            ...
            <div class="col-12 col-md-6 col-lg-4 mb-4">
                <div class="residuo-card rounded-3 overflow-hidden shadow-sm">
                    ...
                    <div class="collage-organicos">
                        ...
                        <img src="<?php echo e(asset('images/collage_organicos.jpg')); ?>" class="img-fluid" alt="Imágenes de residuos orgánicos y compostaje">
                    </div>
            ...
            <div class="col-12 col-md-6 col-lg-4 mb-4">
                <div class="residuo-card rounded-3 overflow-hidden shadow-sm">
                    ...
                    <div class="collage-inorganicos">
                        <img src="<?php echo e(asset('images/collage_inorganicos.jpg')); ?>" class="img-fluid" alt="Imágenes de residuos inorgánicos y reciclaje">
                    </div>
            ...
            <div class="col-12 col-md-6 col-lg-4 mb-4">
                <div class="residuo-card rounded-3 overflow-hidden shadow-sm">
                    ...
                    <div class="collage-peligrosos">
                        <img src="<?php echo e(asset('images/collage_peligrosos.jpg')); ?>" class="img-fluid" alt="Imágenes de residuos peligrosos y manejo experto">
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/carlo/Desktop/Programming Path 2025/Full-Stack Folder/EcoRecolect/EcoRecolect_2025/resources/views/home/landing_page.blade.php ENDPATH**/ ?>